...
bool obj_nil_is_truthy(const obj_nil_t* self);
size_t obj_nil_hash(const obj_nil_t* self);
obj_t* obj_nil_eval(const obj_nil_t* self, obj_env_t* env);
obj_t* obj_nil_apply(const obj_nil_t* self, obj_t* args, obj_env_t* env);
